...
## 🎯 Gold Layer: Executive Metrics (2026-06-25)

| Metric | Value (VND/lượng) |
|---|---|
| Ask (Buy) | **143.200.000** |
| Bid (Sell) | **146.200.000** |
| Spread | 3.000.000 |
...
|---|---:|---:|---:|
| BTMC SJC | 142.000.000 | 146.200.000 | 4.200.000 |
| BTMH | 141.500.000 | 146.000.000 | 4.500.000 |
...
| Phú Qúy SJC | 142.500.000 | 146.000.000 | 3.500.000 |
| SJC | 143.200.000 | 146.200.000 | 3.000.000 |
...
| Indicator | Delta (VND) |
|---|---|
| Ask Price | 📉 -800.000 (-0.56%) |
| Bid Price | 📉 -800.000 (-0.54%) |
...
_Pipeline triggered at **2026-06-25 11:08 +07** via [GitHub Actions](.github/workflows/daily-update.yml)._  
_Data Lineage: [`data/silver/prices.json`](data/silver/prices.json) · 46 historical snapshots (2026-06-04 → 2026-06-25)._  
